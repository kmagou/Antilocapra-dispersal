...
rast_glyp <- rast("median_consensus_maxsssthresh.asc")
plot(rast_glyp)

setwd("C:/Users/Kat/Desktop/Antilocapra/kuenm_antilocapra/112_median_E_maxsss_thresh")
rast_ant <- rast("median_consensus_maxsssthresh.asc")
plot(rast_ant)
...
writeRaster(glyp_crop_albers, "glyp_crop_albers.tif")
writeRaster(ant_crop_albers, "ant_crop_albers.tif")
