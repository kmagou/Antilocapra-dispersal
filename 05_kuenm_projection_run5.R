...
library(kuenm)  #kuenm v.1.1.10
library(readr)  #readr v.2.1.5

####note current calibration area buffer is 750km

#getting training and testing data
setwd("C:/Users/Kat/Desktop/Antilocapra/data/antilocapra")
occs <- read_csv(file="antilocapra_filtered_env_2.csv", col_names=TRUE)
occs <- occs[c("LONG", "LAT")]
occs['Species']='Antilocapra' 
occs <- occs[, c(3, 1, 2)]
train_prop <- 0.8
method = "random"
name = "pts"
...
maxent_path <- "C:/Users/Kat/Desktop/Antilocapra"
wait <- FALSE
run <- TRUE
