...
writeRaster(reclassifiedRasterM,"Antilocapra_Set_1_tfgse_median_M_0.9_F_lt_Set_1_E_maxsss_thresh.asc", overwrite = T)
...
##Reclassify suitability surface
reclassifiedRasterM <- classify(suitabilitySurface,c(-Inf,threshValueM,0,threshValueM,Inf,1));
writeRaster(reclassifiedRasterM,"Antilocapra_Set_1_tfgse_median_M_1_F_lt_Set_1_E_maxsss_thresh.asc", overwrite = T)
